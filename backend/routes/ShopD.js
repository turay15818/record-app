...
router.post("/api/orangeMoneyAfrica-for-shop-D/Android", (req, res) => {
...
router.post("/api/orangeMoneyAfrica-for-shop-D/Iphone", (req, res) => {
    const { downloadLocation, appDownloaded } = req.body;
    const sql = "INSERT INTO downloadInformation (downloadLocation, appDownloaded) VALUES (?, ?) ON DUPLICATE KEY UPDATE timestamp=CURRENT_TIMESTAMP";
    const values = [downloadLocation, appDownloaded];
    connection.query(sql, values, (error, results, fields) => {
...
router.post("/api/myOrange-for-shop-D/Android", (req, res) => {
    const { downloadLocation, appDownloaded } = req.body;
    const sql = "INSERT INTO downloadInformation (downloadLocation, appDownloaded) VALUES (?, ?) ON DUPLICATE KEY UPDATE timestamp=CURRENT_TIMESTAMP";
    const values = [downloadLocation, appDownloaded];
    connection.query(sql, values, (error, results, fields) => {
...
router.post("/api/myOrange-for-shop-D/Iphone", (req, res) => {
    const { downloadLocation, appDownloaded } = req.body;
    const sql = "INSERT INTO downloadInformation (downloadLocation, appDownloaded) VALUES (?, ?) ON DUPLICATE KEY UPDATE timestamp=CURRENT_TIMESTAMP";
    const values = [downloadLocation, appDownloaded];
    connection.query(sql, values, (error, results, fields) => {
