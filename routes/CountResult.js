...
router.get('/oneWeek', (req, res) => {
    const sql = `
select 'my_orange_app_download_for_iphone_at_hqshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Headquarter Shop' and appDownloaded = 'My Orange App For Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'my_orange_app_download_for_android_at_hqshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Headquarter Shop' and appDownloaded = 'My Orange App For Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_iphone_at_hqshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Headquarter Shop' and appDownloaded = 'Orange Money Africa Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_android_at_hqshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Headquarter Shop' and appDownloaded = 'Orange Money Africa Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)

union all

select 'my_orange_app_download_for_iphone_at_flagshipshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Flagship Shop' and appDownloaded = 'My Orange App For Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'my_orange_app_download_for_android_at_flagshipshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Flagship Shop' and appDownloaded = 'My Orange App For Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_iphone_at_flagshipshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Flagship Shop' and appDownloaded = 'Orange Money Africa Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_android_at_flagshipshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Flagship Shop' and appDownloaded = 'Orange Money Africa Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)

union all

select 'my_orange_app_download_for_iphone_at_wellingtonshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Wellington Shop' and appDownloaded = 'My Orange App For Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'my_orange_app_download_for_android_at_wellingtonshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Wellington Shop' and appDownloaded = 'My Orange App For Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_iphone_at_wellingtonshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Wellington Shop' and appDownloaded = 'Orange Money Africa Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_android_at_wellingtonshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Wellington Shop' and appDownloaded = 'Orange Money Africa Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)

union all

select 'my_orange_app_download_for_iphone_at_waterlooshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Waterloo Shop' and appDownloaded = 'My Orange App For Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'my_orange_app_download_for_android_at_waterlooshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Waterloo Shop' and appDownloaded = 'My Orange App For Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_iphone_at_waterlooshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Waterloo Shop' and appDownloaded = 'Orange Money Africa Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_android_at_waterlooshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Waterloo Shop' and appDownloaded = 'Orange Money Africa Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)

union all

select 'my_orange_app_download_for_iphone_at_makenishop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Makeni Shop' and appDownloaded = 'My Orange App For Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'my_orange_app_download_for_android_at_makenishop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Makeni Shop' and appDownloaded = 'My Orange App For Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_iphone_at_makenishop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Makeni Shop' and appDownloaded = 'Orange Money Africa Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_android_at_makenishop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Makeni Shop' and appDownloaded = 'Orange Money Africa Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)

union all

select 'my_orange_app_download_for_iphone_at_konoshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Kono Shop' and appDownloaded = 'My Orange App For Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'my_orange_app_download_for_android_at_konoshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Kono Shop' and appDownloaded = 'My Orange App For Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_iphone_at_konoshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Kono Shop' and appDownloaded = 'Orange Money Africa Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_android_at_konoshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Kono Shop' and appDownloaded = 'Orange Money Africa Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)

union all

select 'my_orange_app_download_for_iphone_at_boshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Bo Shop' and appDownloaded = 'My Orange App For Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'my_orange_app_download_for_android_at_boshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Bo Shop' and appDownloaded = 'My Orange App For Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_iphone_at_boshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Bo Shop' and appDownloaded = 'Orange Money Africa Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_android_at_boshop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Bo Shop' and appDownloaded = 'Orange Money Africa Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)

union all

select 'my_orange_app_download_for_iphone_at_kenemashop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Kenema Shop' and appDownloaded = 'My Orange App For Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'my_orange_app_download_for_android_at_kenemashop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Kenema Shop' and appDownloaded = 'My Orange App For Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all 
select 'orange_money_africa_app_download_for_iphone_at_kenemashop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Kenema Shop' and appDownloaded = 'Orange Money Africa Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_android_at_kenemashop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Kenema Shop' and appDownloaded = 'Orange Money Africa Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)

union all

select 'my_orange_app_download_for_iphone_at_lungishop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Lungi Shop' and appDownloaded = 'My Orange App For Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'my_orange_app_download_for_android_at_lungishop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Lungi Shop' and appDownloaded = 'My Orange App For Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_iphone_at_lungishop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Lungi Shop' and appDownloaded = 'Orange Money Africa Iphone' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY)
union all
select 'orange_money_africa_app_download_for_android_at_lungishop' as total_downloads, count(downloadLocation) as total from downloadInformation where downloadLocation = 'Lungi Shop' and appDownloaded = 'Orange Money Africa Android' AND timestamp >= DATE_SUB(NOW(), INTERVAL 1 DAY);
